    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Измена подешавања</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="update">
                        ...
                        <div class="form-group{{ $errors->has('quiz_duration') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="quiz_duration" type="number" class="form-control" name="quiz_duration" value="{{Setting::get('quiz_duration', 10)}}" required>
                        ...
                        <div class="form-group{{ $errors->has('activation_timeout_minutes') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="activation_timeout_minutes" type="number" class="form-control" name="activation_timeout_minutes" value="{{Setting::get('activation_timeout_minutes', 10)}}" required>
                        ...
                        <div class="form-group{{ $errors->has('final_quiz_questions') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="final_quiz_questions" type="number" class="form-control" name="final_quiz_questions" value="{{Setting::get('final_quiz_questions', 10)}}" required>
                        ...
                        <div class="form-group{{ $errors->has('questions_per_page') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="questions_per_page" type="number" class="form-control" name="questions_per_page" value="{{Setting::get('questions_per_page', 10)}}" required>
                        ...
                        <div class="form-group{{ $errors->has('final_quiz_max_negative') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="final_quiz_max_negative" type="number" class="form-control" name="final_quiz_max_negative" value="{{Setting::get('final_quiz_max_negative', 10)}}" required>
                    ...
                    <button class='btn btn-primary' type="button" onclick="window.location='{{ url('admin/settings/') }}'">Назад</button>
                </div>
            </div>
        </div>
    </div>  
