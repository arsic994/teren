    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><h3>Измена понуђеног одговора</h3></div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="update">
                        ...
                        <div class="form-group{{ $errors->has('option') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="option" type="text" class="form-control" name="option" value="{{$option->option}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('is_correct') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                @if ($option->is_correct == 1)
                                    <input id="is_correct" type="checkbox" class="form-control" name="is_correct" autofocus checked>
                                @else
